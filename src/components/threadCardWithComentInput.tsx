...
import { CommentSharp, MoreVertSharp, ThumbDown, ThumbDownAltSharp, ThumbDownOffAltSharp, ThumbDownOutlined, ThumbDownSharp, ThumbUp, ThumbUpAltSharp, ThumbUpOffAltSharp, ThumbUpOutlined, ThumbUpSharp, VisibilityOffOutlined, VisibilityOutlined, VisibilitySharp } from '@mui/icons-material';
...
const ThreadCardWithCommentInput = ({ thread, width, disableOnClick }: { thread: Thread, width?: string, disableOnClick?: boolean}) => {
...
export default ThreadCardWithCommentInput;