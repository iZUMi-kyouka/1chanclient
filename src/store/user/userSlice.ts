...
const userSlice = createSlice({
  ...
  reducers: {
    updateUser(
      state,
      action: PayloadAction<{ account: UserAccount; profile: UserProfile }>
    ) {
...
export const selectUserLikedThreads = (state: RootState) =>
  state.user.liked_threads;
export const selectUserLikedComments = (state: RootState) =>
  state.user.liked_comments;
export const selectUserWrittenThreads = (state: RootState) =>
  state.user.threads;
export const selectUserWrittenComments = (state: RootState) =>
  state.user.comments;
